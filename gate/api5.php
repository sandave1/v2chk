...
elseif(strpos($result2, "succeeded")) {
    ...
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result:CHARGED '.$amt.' ✅ArpitItachi☯_'.$ip.' </span><br>';
exit;
}

elseif(strpos($result2, "Your card has insufficient funds.")) {

    echo '#CVV</span>  </span>CC:  '.$lista.'</span>  <br>Result: CVV LIVE ✅ArpitItachi☯_'.$ip.'  </span><br>';
    exit;
    }
...
elseif(strpos($result2, 'security code is incorrect.')) {
    ...
    echo '#CCN</span>  </span>CC:  '.$lista.'</span>  <br>Result: CCN LIVE ✅ArpitItachi☯_'.$ip.'  </span><br>';
    exit;
    }
...
elseif(strpos($result2, "Membership Confirmation")) {
    ...
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result: Membership Confirmation '.$amt.' ✅ArpitItachi☯_'.$ip.' </span><br>';
exit;
}
